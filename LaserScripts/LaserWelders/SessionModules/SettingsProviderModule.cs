...
{
    public class SettingsProviderModule : SettingsProviderModuleBase<LaserSettings>
    {
        public SettingsProviderModule(ISessionKernel MySessionKernel) : base(MySessionKernel) { }

        public override string DebugModuleName { get; } = nameof(SettingsProviderModule);

        protected override LaserSettings Default { get; } = LaserSettings.Default;

        protected override string SettingsFileName { get; } = "laserweldersv2.sbc";

        protected override string ChatName { get; } = "Laser Tools";

        protected override IReadOnlyList<string> ReloadChatCommands { get; } = new List<string>
        {
