...
namespace EemRdx.LaserWelders.EntityModules.ShipControllerModules
{
    ...
    public class HUDModule : EntityModuleBase<ISCKernel>, InitializableModule, UpdatableModule, ClosableModule, IHUDModule
    {
        ...
        private readonly Vector2D DefaultOrigin = new Vector2D(SCPersistenceModule.Fallback.HudPosX, SCPersistenceModule.Fallback.HudPosY);
        ...
        private static StringBuilder PrintToolVerboseStatus(ILaserToolKernel Tool)
        {
